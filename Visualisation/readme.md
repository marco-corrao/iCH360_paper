In this folder, you can find a number of maps built in Escher [1], which were use to produce all maps (including those with overlaid flux distributions) in the paper.
#### `./model_map`
